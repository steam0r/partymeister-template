...
class VisitorRegisteredEventListener
{
    ...
    public function handle(VisitorRegistered $event)
    {
        ...
        switch ($visitorCount % 10) {
            case 1: $seatNumber = $maxRows.'A'; break;
            case 2: $seatNumber = $maxRows.'B'; break;
            case 3: $seatNumber = $maxRows.'C'; break;
            case 4: $seatNumber = $maxRows.'D'; break;
            case 5: $seatNumber = $maxRows.'E'; break;
            case 6: $seatNumber = $maxRows.'F'; break;
            case 7: $seatNumber = $maxRows.'G'; break;
            case 8: $seatNumber = $maxRows.'H'; break;
